Module Functions
    ...
    'Builds a 2-dimensional array of strings based on the inputFilename given
    'Requires an input filename which is comma seperated text file
